...
# Load tabX trees
fileName <- (paste0(config$PATH_rdata, "tabX_layerAggr_", config$VAR_layer_names[1],".rdata"))
load(fileName)
tabX_trees <- tabX

# Load tabX clusters
fileName <- (paste0(config$PATH_rdata, "tabX_layerAggr_", config$VAR_layer_names[2],".rdata"))
load(fileName)
tabX_clusters <- tabX
...
# Plot combined
species_plot_path <-paste0("data/plots/by_site/side_by_side/residuals/species/", config$VAR_data_from, "/combined/")
...
# Plot combined
site_plot_path <-paste0("data/plots/by_site/side_by_side/residuals/site/", config$VAR_data_from, "/combined/")
